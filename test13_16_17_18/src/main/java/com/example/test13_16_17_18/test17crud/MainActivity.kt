...
//crud 기본테스트
//경로
//https://github.com/lsy3709/K230201AndroidLab/blob/master/test17-crud/src/main/java/com/example/test17_crud/MainActivity.kt
//바인딩 수정. databaseHelper 생성.
//AlertDialog 임포트. delete버튼 findById형식으로 중복 되어있어서 삭제
...
class MainActivity : AppCompatActivity() {
    ...
    // 할당을 하는 구조.
    //마치 DAO Repository Mybatis Mapper JPA 바이브
